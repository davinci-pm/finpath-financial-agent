...
/**
 * P10 我的金融任务中心
 * 状态筛选为本地状态，不刷新整页；第一张为主要任务（占最大面积）。
 * 参考：P10-task-center.png
 */
        ...
        <aside className="space-y-4">
          <Card className="rounded-2xl bg-card shadow-card">
            ...
            <CardContent className="space-y-3">
              {[
                { icon: CheckCircle2, text: "完成 2 项任务" },
          ...
          <Card className="rounded-2xl bg-card shadow-card">
            <CardContent className="flex items-center gap-5 p-6">
              ...
              <div>
                ...
                <p className="mt-0.5 text-sm text-muted-foreground">办理境外支付卡 · 进行中</p>
                <Button size="sm" variant="outline" className="mt-3 gap-1.5 rounded-xl" asChild>
                  <Link href="/tasks/t-overseas-card">
                    继续
